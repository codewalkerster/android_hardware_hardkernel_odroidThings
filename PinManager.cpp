...
PinManager::PinManager(){
    ...
    else if (!name.compare(0, strlen("odroidc5"), "odroidc5"))
        board = std::make_shared<OdroidC5>();
    ...
    else if (!name.compare(0, strlen("odroidm2"), "odroidm2"))
        board = std::make_shared<OdroidM2>();
    else {
