...
OdroidC5::OdroidC5() {
    pinList = {
        ...
        {"15", 3, PIN_GPIO}, {"16", 4, PIN_GPIO},
        {"3.3V", -1, PIN_PWR}, {"18", 5, PIN_GPIO|PIN_PWM},
        {"19", 12, PIN_GPIO|PIN_SPI}, {"GND", -1, PIN_GND},
        {"21", 13, PIN_GPIO|PIN_SPI}, {"22", 6, PIN_GPIO},
        {"23", 14, PIN_GPIO|PIN_SPI|PIN_I2C}, {"24", 10, PIN_GPIO|PIN_SPI|PIN_I2C},
        {"25", -1, PIN_GND}, {"26", 11, PIN_GPIO|PIN_PWM},
    ...
    i2cList = {
        ...
        {"I2C-3", "/dev/i2c-2", 10, 14}, // Pin #24, #23
    };

    pwmList = {
        { // Pin #12 a
            .index = 1,
            .path = "/sys/devices/platform/soc/fe000000.apb4/fe058000.pwm",
            .line = 0
        },
        { // Pin #7 b
            .index = 7,
            .path = "/sys/devices/platform/soc/fe000000.apb4/fe058200.pwm",
            .line = 0
        },
        { // Pin #18 c
            .index = 5,
            .path = "/sys/devices/platform/soc/fe000000.apb4/fe058400.pwm",
            .line = 0
        },
        { // Pin #26 f
            .index = 11,
    ...
    uartList = {
        ...
        {"UART-2", "/dev/ttyS2", 30, 31}, // Pin #27, #28
        {"UART-3", "/dev/ttyS3", 11, 26}, // Pin #31, #29
